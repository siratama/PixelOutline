...
common.PixelOutlineInitialErrorEvent.ERROR = function(message) { var $x = ["ERROR",5,message]; $x.__enum__ = common.PixelOutlineInitialErrorEvent; return $x; };
var extension = {};
...
extension.Panel.prototype = {
	...
	,observeToClickUI: function() {
		if(this.view.runButton.isClicked()) this.initializeToCallPixelOutline();
	}
	,initializeToCallPixelOutline: function() {
		this.pixelOutlineRunner.call(this.view.isCreatedNewLayer());
		this.changeRunning($bind(this,this.callPixelOutline),50);
	}
	,callPixelOutline: function() {
		this.pixelOutlineRunner.run();
		if(this.pixelOutlineRunner.isFinished()) this.initializeToClickUI();
	}
	,__class__: extension.Panel
};
extension.PixelOutlineRunnerEvent = $hxClasses["extension.PixelOutlineRunnerEvent"] = { __ename__ : ["extension","PixelOutlineRunnerEvent"], __constructs__ : ["INITIAL_ERROR","SUCCESS","NONE"] };
extension.PixelOutlineRunnerEvent.INITIAL_ERROR = function(error) { var $x = ["INITIAL_ERROR",0,error]; $x.__enum__ = extension.PixelOutlineRunnerEvent; return $x; };
	...
	,observeToRecieveInitialErrorEvent: function() {
		{
			...
			case 1:
				...
				case 0:
					...
					break;
				default:
					this.destroy(extension.PixelOutlineRunnerEvent.INITIAL_ERROR(initialErrorEvent));
				}
				break;
			}
		}
...
extension.View.prototype = {
	isCreatedNewLayer: function() {
		return this.isChecked("new_layer_creation");
	}
